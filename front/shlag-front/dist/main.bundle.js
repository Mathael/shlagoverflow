...
module.exports = "<div id=\"flex-center\">\r\n    <div>\r\n        <h1>ShlagOverflow</h1>\r\n    </div>\r\n    <div>\r\n        <md-input-container class=\"example-full-width\">\r\n            <input mdInput placeholder=\"Rercherche\" #query (keyup)=\"doSearch(query.value)\">\r\n        </md-input-container>\r\n        <div id=\"results\">\r\n            <div *ngFor=\"let r of results\">\r\n                {{ r.score }} : {{ r.title }}\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n"
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.doSearch = function (query) {
        var _this = this;
        this.search.do(query).subscribe(function (res) {
            _this.results = res;
        });
    };
    return AppComponent;
...
AppComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__services_search_service__["a" /* SearchService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__services_search_service__["a" /* SearchService */]) === "function" && _a || Object])
], AppComponent);
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["b" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_0__services_search_service__["a" /* SearchService */]],
...
var SearchService = (function () {
    function SearchService(http) {
        this.http = http;
        this.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Headers */]({ 'Content-Type': 'application/json', 'Accept': 'application/json' });
        this.options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* RequestOptions */]({ headers: this.headers });
    }
    /**
     * Return : Array of Questions
     */
    SearchService.prototype.do = function (query) {
        return this
            .http
